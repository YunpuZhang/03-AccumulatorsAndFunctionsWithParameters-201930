...
def run_test_sum_of_digits():
    ...
    # Test 2:
    expected = 23
    answer = sum_of_digits(94028)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 35
    answer = sum_of_digits(77777)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 31
    answer = sum_of_digits(31415926)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
